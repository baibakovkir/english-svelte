import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component, n as noop, a as safe_not_equal } from './chunks/ssr-DuKu5otS.js';
...
const options = {
  ...
  templates: {
	...
	<style>\r
		body {\r
			--floral-white: #fffcf2ff;\r
			--timberwolf: #ccc5b9ff;\r
			--black-olive: #403d39ff;\r
			--eerie-black: #252422ff;\r
			--flame: #eb5e28ff;\r
			--bg-1: hsl(0, 0%, 100%);\r
			--bg-2: hsl(206, 20%, 90%);\r
			--bg-3: hsl(206, 20%, 80%);\r
			--fg-1: hsl(0, 0%, 13%);\r
			--fg-2: hsl(0, 0%, 20%);\r
			--fg-2: hsl(0, 0%, 30%);\r
			...
			--font-mono: ui-monospace, 'Cascadia Code', 'Source Code Pro', Menlo, Consolas,\r
				'DejaVu Sans Mono', monospace;\r
			background: var(--bg-1);\r
			color: var(--fg-1);\r
...
\r
		a:hover {\r
			color: var(--link-hover);\r
		}\r
\r
		a:active {\r
			color: var(--link-active);\r
		}\r
\r
		label {\r
			display: flex;\r
...
\r
		select:not([multiple]) {\r
			background: var(--bg-2);\r
		}\r
\r
		textarea {\r
...
\r
		progress:first-child {\r
			margin-top: 0;\r
		}\r
\r
		progress:lsat-child {\r
			margin-bottom: 0;\r
		}\r
\r
		.error {\r
...
\r
		body.dark {\r
			...
			--fg-2: hsl(0, 0%, 70%);\r
			--fg-3: hsl(0, 0%, 60%);\r
			--link: hsl(206, 96%, 72%);\r
			--link-hover: hsl(206, 96%, 78%);\r
			--link-active: hsl(206, 96%, 64%);\r
		}\r
\r
		footer {\r
