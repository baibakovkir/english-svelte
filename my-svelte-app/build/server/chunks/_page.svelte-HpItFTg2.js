import { c as create_ssr_component, e as escape, b as add_attribute, f as each } from './ssr-DuKu5otS.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `${$$result.head += `<!-- HEAD_svelte-zg4c03_START -->${$$result.title = `<title>${escape(data.post.title)}</title>`, ""}<!-- HEAD_svelte-zg4c03_END -->`, ""}  <section class="initial"><div class="initial__top"><h1 class="initial__title initial__title_right">${escape(data.post.title)}</h1> <div class="initial__top-link"><a href="${"/text/" + escape(data.post.slug, true)}" class="initial__task-link">Перейти к тексту<img class="initial__link__arrow"${add_attribute("src", arrowRight, 0)} alt="arrow"></a></div></div> <div class="initial__about">${each(content, (content2, i) => {
...
//# sourceMappingURL=_page.svelte-HpItFTg2.js.map
