const posts = [
  {
    ...
    section1: {
      text1: "Sometimes we use two or more adjectives together:",
  ...
  },
  {
    ...
    section1: {
      text1: "When discussing the usage of “it” in a sentence, it is essential to begin by understanding the basic definition of this pronoun. In English grammar, “it” is a singular, gender-neutral pronoun used to refer to a previously mentioned or understood noun.",
      example1: "",
      example2: "",
  ...
  },
  {
    ...
    slug: "there-to-be",
    section1: {
      text1: "Do you know how to use there is and there are? Test what you know with interactive exercises and read the explanation to help you. Look at these examples to see how we use there is and there are.",
  ...
  },
  {
    ...
    //https://studfile.net/preview/3682072/page:39/
    slug: "compound-sentences",
    section1: {
      text1: "Сложносочинённое предложение состоит из равноправных простых предложений (clauses), грамматически независящих друг от друга. Простые предложения (clauses) соединяются сочинительными союзами и обычно отделяются запятой.",
  ...
  },
  {
    ...
    section1: {
      text1: "В отличие от сложносочиненных предложений, которые содержат несколько независимых предложений, в состав сложноподчиненных предложений входит только одно независимое предложение и как минимум одно зависимое предложение.",
...
export { posts as p };
//# sourceMappingURL=data3-BYvro4bm.js.map
