...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-zg4c03_START -->${$$result.title = `<title>${escape(data.post.title)}</title>`, ""}<!-- HEAD_svelte-zg4c03_END -->`, ""}  <section class="initial">${validate_component(TextHeaderShine, "TextTitle").$$render($$result, { title: data.post.title }, {}, {})} ${validate_component(LinkAnimated, "LinkAnimated").$$render(
    $$result,
    {
      link: "/text/" + data.post.slug,
      name: "Далее"
    },
    {},
    {}
  )} <div class="initial__about">${each(content, (content2, i) => {
...
//# sourceMappingURL=_page.svelte-VMLj2zc6.js.map
