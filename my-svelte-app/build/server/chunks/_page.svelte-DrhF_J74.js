...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Sidebar, "Sidebar").$$render($$result, {}, {}, {
    ...
    return `<a class="menu__menu__item__link" href="${"/text/" + escape(slug, true)}"><div class="menu__menu__item"><li class="menu__menu__item__text">${escape(title)}</li> </div></a>`;
  })}</ul></div></section>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-DrhF_J74.js.map
